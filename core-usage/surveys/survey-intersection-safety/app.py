...
def header():
    ...
    title = html.H1("Visuele veiligheidsbeoordeling van Rotterdamse kruispunten", style = {"fontSize": "30px", "color":"white"})
    subtitle = html.H6("Expertbeoordeling via paarsgewijze vergelijking — TU Delft / Gemeente Rotterdam", style = {"fontSize": "20px", "color":"white"}, className = "lead")
...
def footer():
    return html.Div([
        ...
        html.Div([
            html.P([
                "Survey ID: ",
                html.Strong("intersection-safety", style={"color": survey_color}),
                " | Generated with ",
